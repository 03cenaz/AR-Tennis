...
//    public float launchForce;
    ...
    {
        Debug.Log("TOP ÇARPTI: " + collision.gameObject.name); // bu çalışıyor mu?
     //  Debug.Log("bounceSound: " + bounceSound); // bu çalışıyor mu?
     //   Debug.Log("audioSource: " + audioSource); // bu çalışıyor mu?
        // VOICE
        ...
        // BALL HIT NUMBER
        ballCollisionCount ++;
        if (collision.gameObject.CompareTag("SquashFloor"))
        {
            inside = true;
